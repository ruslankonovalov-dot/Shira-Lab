...
class MouseHotkeyManager:
    ...
    def __init__(self, dispatcher):
        ...
        self._mouse_bindings: dict[str, dict] = {}  # button_key → {action, mode, on_press, on_release}
    ...
    def register_mouse(self, action: str, key: str, mode: str,
    ...
    def register_wheel(self, action: str, key: str, mode: str,
                       on_trigger: Callable) -> tuple[bool, str | None]:
    ...
    def _handle_click(self, button, pressed: bool):
        ...
        button_map = {Button.left: "left", Button.right: "right",
                      Button.middle: "middle", Button.x1: "mouse4", Button.x2: "mouse5"}
