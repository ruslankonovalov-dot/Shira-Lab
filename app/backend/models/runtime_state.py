...
class RuntimeState:
    ...
    pico_button_map: dict[str, str] = field(
        default_factory=lambda: {
            "space": "A",
            "enter": "A",
            "shift": "LB",
    ...
    clicker_config: dict[str, Any] = field(
        default_factory=lambda: {
            "interval_ms": 100,
            "hold_ms": 0,
            "button": "L",
    ...
    macro_config: dict[str, Any] = field(
        default_factory=lambda: {"mode": "SEQUENTIAL", "background_method": "sendinput"}
    )
    recorder_config: dict[str, Any] = field(
        default_factory=lambda: {"background_method": "sendinput"}
    )
