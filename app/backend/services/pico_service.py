...
from app.backend.services.pico_protocol import (CMD_GET_INFO, CMD_GP_BUTTONS,
                                                CMD_GP_STATE, CMD_GP_STICK,
                                                CMD_GP_TRIGGERS, CMD_KB_PRESS,
                                                CMD_KB_RELEASE, CMD_KB_TAP,
                                                CMD_MS_CLICK, CMD_MS_MOVE,
                                                CMD_MS_PRESS, CMD_MS_RELEASE,
                                                CMD_MS_SCROLL, CMD_PING,
                                                CMD_RESET, CMD_SET_MODE,
                                                RESP_INFO, RESP_OK, RESP_PONG,
                                                PicoInfo,
